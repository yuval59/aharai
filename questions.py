...
def MostRepeated(str):
    '''
    Write a program that accepts a string str1 as input, and print the most repeated
    character in it, for example: str1="littttttle"
    the program would print "t"
    '''


def youngest_sibling(dict1):
    '''
...
def neighbor_multiplication(lst):
    '''
